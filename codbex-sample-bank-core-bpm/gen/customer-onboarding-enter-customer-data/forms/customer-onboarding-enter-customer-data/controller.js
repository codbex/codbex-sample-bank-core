angular.module('forms', ['blimpKit', 'platformView', 'platformLocale']).controller('FormController', ($scope, $http, LocaleService, ViewParameters) => {
    ...
    $http.get(`/services/ts/codbex-sample-bank-core-bpm/api/customerData.ts?taskId=${taskId}`).then((response) => {
    ...
    $scope.createCustomer = function () {
        $http.post(`/services/ts/codbex-sample-bank-core-bpm/api/customerData.ts?taskId=${taskId}`, {
