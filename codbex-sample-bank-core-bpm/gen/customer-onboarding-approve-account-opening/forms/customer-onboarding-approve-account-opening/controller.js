angular.module('forms', ['blimpKit', 'platformView', 'platformLocale']).controller('FormController', ($scope, $http, LocaleService, ViewParameters) => {
    ...
    $http.get(`/services/ts/codbex-sample-bank-core-bpm/api/accountData.ts?taskId=${taskId}`).then((response) => {
    ...
    $scope.createAccount = function () {
        $http.post(`/services/ts/codbex-sample-bank-core-bpm/api/accountData.ts?taskId=${taskId}`, {
