...
const validationModules = await Extensions.loadExtensionModules('codbex-sample-bank-core-edm-customers-Customer', ['validate']);

@Controller
@Documentation('codbex-sample-bank-core-edm - Customer Controller')
// @Injected()
class CustomerController {
    ...
    public create(entity: CustomerEntity): CustomerEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-bank-core-edm/gen/bankCore/api/customers/CustomerService.ts/' + entity.id);
