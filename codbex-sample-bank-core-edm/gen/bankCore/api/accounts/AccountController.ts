...
const validationModules = await Extensions.loadExtensionModules('codbex-sample-bank-core-edm-accounts-Account', ['validate']);
...
class AccountController {
    ...
    public create(entity: AccountEntity): AccountEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-bank-core-edm/gen/bankCore/api/accounts/AccountService.ts/' + entity.id);
