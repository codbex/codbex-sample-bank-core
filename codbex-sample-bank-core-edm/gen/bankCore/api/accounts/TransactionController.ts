...
const validationModules = await Extensions.loadExtensionModules('codbex-sample-bank-core-edm-accounts-Transaction', ['validate']);

@Controller
@Documentation('codbex-sample-bank-core-edm - Transaction Controller')
// @Injected()
class TransactionController {
    ...
    public create(entity: TransactionEntity): TransactionEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-bank-core-edm/gen/bankCore/api/accounts/TransactionService.ts/' + entity.id);
