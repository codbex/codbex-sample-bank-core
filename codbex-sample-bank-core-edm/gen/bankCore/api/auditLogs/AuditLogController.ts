...
const validationModules = await Extensions.loadExtensionModules('codbex-sample-bank-core-edm-auditLogs-AuditLog', ['validate']);

@Controller
@Documentation('codbex-sample-bank-core-edm - AuditLog Controller')
// @Injected()
class AuditLogController {
    ...
    public create(entity: AuditLogEntity): AuditLogEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-bank-core-edm/gen/bankCore/api/auditLogs/AuditLogService.ts/' + entity.id);
