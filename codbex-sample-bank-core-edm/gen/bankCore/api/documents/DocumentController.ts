...
const validationModules = await Extensions.loadExtensionModules('codbex-sample-bank-core-edm-documents-Document', ['validate']);

@Controller
@Documentation('codbex-sample-bank-core-edm - Document Controller')
@Injected()
class DocumentController {
    ...
    public create(entity: DocumentEntity): DocumentEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-bank-core-edm/gen/bankCore/api/documents/DocumentService.ts/' + entity.id);
